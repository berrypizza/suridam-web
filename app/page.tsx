export const metadata = {
  title: "가구 수리 | 소파 꺼짐, 싱크대 상부장 처짐 그냥 두면 더 커집니다",
  description:
    "가구를 버리기 전에 확인하세요. 소파 꺼짐, 상부장 처짐 대부분 수리로 해결되는 경우 많습니다. 사진 한 장 보내주시면 지금 상태 기준으로 바로 판단해드립니다. 출강 가능 지역, 인천, 서울, 부천, 등 수도권",
  openGraph: {
